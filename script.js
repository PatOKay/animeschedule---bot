...
async function init() {
    ...
    document.getElementById('globalSearch').addEventListener('input', (e) => {
        ...
        if (query.length > 2) setTimeout(() => performSearch(query), 500);
    ...
    body.innerHTML = `
        <div style="display:flex; gap:20px; flex-wrap:wrap;">
            ...
            <div style="flex:1; min-width:300px;">
                ...
                ${ytId ? `<iframe width="100%" height="250" src="https://www.youtube.com/embed/${ytId}" style="margin-top:15px; border-radius:10px;" frameborder="0" allowfullscreen></iframe>` : `<p style="margin-top:15px; color:#888;">Trailer not available</p>`}
            </div>
        </div>`;
}
